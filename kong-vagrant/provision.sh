...
echo "*************************************************************************"
echo "Configuring resolv with netplan"
echo "*************************************************************************"

sudo sed -i 's/address: .*/addresses: [8.8.8.8,8.8.4.4]/g' /etc/netplan/01-netcfg.yaml
sudo netplan apply
echo "Finished"
...
sudo sed -i 's/^bind 127.0.0.0.1.*/bind 127.0.0.1/g' /etc/redis/redis.conf
...
echo "*************************************************************************"
echo "Copy base kong configuration"
echo "*************************************************************************"

sudo cp /kong/kong.conf /etc/kong/kong.conf
